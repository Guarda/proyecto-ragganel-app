/*******************************************************************************
** ARCHIVO: SCRIPT CREACION DE VISTAS.sql
...
** DESCRIPCIÓN:
** Script completo para la creación de la base de vistas de la base de datos.
*******************************************************************************/

use base_datos_inventario_taller_prueba;
-- ======================================================================================
-- VISTA 1: VistaInventarioAgrupada
-- Propósito: Agrupa el inventario por tipo, fabricante, categoría, subcategoría y
-- estado para obtener un resumen cuantitativo del stock, se usa en el inventario que se muestra 
-- disponible para agregar al carrito de ventas
-- ======================================================================================
...
-- ======================================================================================
-- VISTA 2: VistaArticulosInventarioV3
-- Propósito: Prepara una lista de todos los artículos disponibles para la venta,
-- excluyendo estados específicos. Calcula la cantidad de servicios realizables
-- basándose en el stock de insumos. Ideal para el punto de venta (POS).
-- ======================================================================================
...
-- ======================================================================================
-- VISTA 3: VistaInventarioGeneral
-- Propósito: Proporciona una lista unificada y detallada de todos los artículos FÍSICOS
-- (Productos, Accesorios, Insumos) para una gestión de inventario completa.
-- Muestra la descripción del estado y la fecha de ingreso.
-- ======================================================================================
